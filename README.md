...
- [prometheus](https://github.com/gofiber/contrib/tree/main/v3/prometheus) - Prometheus middleware that instruments incoming requests and serves the metrics endpoint.
